...
## What distro logo to use to use, Available "Crunchbang Archlinux Debian Ubuntu None" ##
my $distro = "Crunchbang";
...
my $command = "scrot -d 5 ~/%Y-%m-%d--%s_scrot.png";
...
if ( $distro =~ m/Crunchbang/ ) {

## Get Crunchbang version ##
if ( $display =~ "OS"){
  print "\::$textcolor Finding Crunchbang version\n" unless $quite == 1;
  my $version = `head -3 /etc/crunchbang-lsb-release |cut -d"=" -f2`;
  $version =~ s/\s+/ /g;
  $version = " OS:$textcolor $version";
  unshift(@line, "$version");
}
...
print "
               ...
               //  /     //  /       || | @line[0]
              //  /     //  /        || | @line[1]
      _______//	 /_____//  /______   || | @line[2]
     //______   _______   _______/   || | @line[3]
           //  /      //  /          || | @line[4]
          //  /      //  /           || | @line[5]
   ______//  /______//  /_____       || | @line[6]
  //_____   _______   _______/       || | @line[7]
       //  /      //  /              ||_| @line[8]
      //  /      //  /                 _
     //__/      //__/                ||_|
...
## return 0;      
## Run screen shot grabbeunless $shot != 0r ##
`$command`; print "Screenshot saved in \e[0m"; print $ENV{HOME}, "\n";